...
int nrf91_slm_socket(
    struct nrf91_slm_data *data, int family, int type, int proto);
...
ssize_t nrf91_slm_sendto(struct nrf91_slm_data *data, void *obj,
    const void *buf, size_t len, int flags, const struct sockaddr *dest_addr,
    socklen_t addrlen);
...
void nrf91_slm_freeaddrinfo(
    struct nrf91_slm_data *data, struct zsock_addrinfo *res);
